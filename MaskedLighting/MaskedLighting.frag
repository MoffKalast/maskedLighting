...
void main(){
    ...
    // ***********************
      ...
      vec4 specularColor = vec4(1.0);
		...
		#ifdef GLOWMASK
			vec4 tex = texture2D(m_GlowMask,newTexCoord);
    		float mask = (tex.r+tex.g+tex.g)/3.0;
    		gl_FragColor.rgb = (1.0-mask)*gl_FragColor.rgb+texture2D(m_DiffuseMap, newTexCoord).rgb*mask;
    	#endif
    #endif
    gl_FragColor.a = alpha;
}
